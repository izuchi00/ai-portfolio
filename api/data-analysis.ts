...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    let prompt = `You are an expert AI assistant. Based on the following dataset overview and the requested analysis type, generate a comprehensive, professional, and easy-to-understand report. Focus on key insights and steps taken (simulated). Do not generate actual code or images, but describe them.
